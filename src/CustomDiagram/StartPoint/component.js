...
const StartPointStyle = style.div`
...
export type StartPointProps = DiagComponentProps & {
  name: string,
  isEditing: boolean,
...
const StartPoint = (props: StartPointProps) => (
  <StartPointStyle width={props.model.width} height={props.model.height}>
    <EditName
      value={props.name}
...
type StartPointComponentProps = DiagComponentProps;
type StartPointComponentState = {
  isEditing: boolean,
  name: string,
};
class StartPointComponent extends React.PureComponent<
  StartPointComponentProps,
  StartPointComponentState
> {
